...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Access your finances anytime, anywhere with modern cloud based acounting technology. Modern cloud-based accounting systems that give you real-time access to your financial data anywhere, anytime. Embrace the future of accounting.",
