...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      title: "Business Tax",
      tag: "Tax Solutions",
      description: "Expert corporate tax planning and compliance services to minimize your tax liability while ensuring full compliance with UK tax regulations.",
      image: taxImg,
    },
    {
      icon: Receipt,
      title: "VAT",
      tag: "VAT Management",
      description: "Complete VAT registration, returns, and advisory services. We ensure accurate submissions and help you navigate complex VAT regulations with ease.",
      image: vatImg,
    },
    {
      icon: Cloud,
      ...
      description: "Modern cloud-based accounting systems that give you real-time access to your financial data anywhere, anytime. Embrace the future of accounting.",
